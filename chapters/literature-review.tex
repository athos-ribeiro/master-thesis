...
The Evolution and Decay of Statically Detected Source Code Vulnerabilities~\cite{penta_evolution_2008}
...
% falta a lista do survey

% listar todos os papers inclusos na revisão em uma tabela

% Selecionados pela metodologia

% relacionados ao survey
% somar na figura e ajustar o texto
