...
learn from obsserved examples, we need to obtain and process a dataset of static
...
We ran 3 static analysis tools to generate the data set for our
experiments. These are the same static analyzers integrated in
kiskadee, since its their output will compose kiskadee final
