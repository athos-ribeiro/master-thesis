...
false positives. The labeling step is feasible beacause we use a set of known
softwre flaws as input for the static analyzers, as we describe in the next
