...
Embora exista grande variedade de analizadores estáticos de código-fonte
...
análise estática para analizar um programa. A combinação das análises de
...
análise estática de código fonte durante o ciclo de desenvilvimento de
software provendo relatórios de anáise estática ranqueados. Primeiro,
\textit{kiskadee} roda diversos analizadores estáticos no código-fonte. Em seguida,
utilizando um modelo de classificação, os potenciais bugs detectados pelos
analizadores estáticos são ranqueados conforme sua importância, onde defeitos
...
pós-análise nos relatórios gerados por três analizadores estáticos ao
analizarem casos de teste sintéticos disponibilizados pelo \textit{National
...
árvores de decisão utilizando o algorítmo AdaBoost para gerar um
...
alarmes dos analizadores estáticos nos baseando na probabilidade de um dado
