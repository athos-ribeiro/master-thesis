...
%\tituloport{Ranking Source Code Static Analysis Warnings for Continuous Monitoring of Free/Libre and Open Source Software Repositories}
...
\banca{
  \begin{itemize}
    \item Prof. Dr. Marcelo Finger - IME-USP
    \item Prof. Dr. Gregorio Robles - UJRC
    \item Prof. Dr. Eduardo Guerra - INPE
  \end{itemize}
}
...
\palavraschave{Análise estática de código-fonte. Qualidade de software. Engenharia de software.}

\keywords{Source code static analysis. Software quality. Software engineering.}
