\begin{figure}[h]
  ...
  \begin{tikzpicture}[level distance=40mm,sibling distance=5mm]
    ...
    \node (3) at (2,-2) [draw, label=below left:{n=97}]{\textbf{MPBR}};
    \node (4) at (0,-4) [draw,label=below left:{n=183}]{Abstract and conclusion review};
    \node (5) at (0,-6) [draw,label=below left:{n=36}]{Included papers};
